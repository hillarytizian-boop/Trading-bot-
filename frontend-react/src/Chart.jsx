...
export default function Chart({ priceHistory, signals, binance }) {
  ...
  useEffect(() => {
    ...
    signalData.forEach((signal, index) => {
      // Find the closest price index to this signal's time
      // For simplicity, use index mapping if signalData aligns with priceHistory
